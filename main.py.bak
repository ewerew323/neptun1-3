...
OBLAST_CENTERS = {
    # Винницкая область
    "вінницька": (49.2328, 28.4817),
    'винницкая': (49.2328, 28.4817),
    'жмеринка': (49.0384, 28.1086),
    'могилів-подільський': (48.4432, 27.7828),
    'хмільник': (49.5590, 27.9574),
    
    # Волынская область
    'волинська': (50.7472, 25.3254),
    'волынская': (50.7472, 25.3254),
    'ковель': (51.2147, 24.7089),
    'нововолынск': (50.7277, 24.1651),
    
    # Днепропетровская область
    'дніпропетровська': (48.4647, 35.0462),
    'днепропетровская': (48.4647, 35.0462),
    'кривий ріг': (47.9097, 33.3809),
    'кривой рог': (47.9097, 33.3809),
    'нікополь': (47.5677, 34.3972),
    'павлоград': (48.5289, 35.8716),
    
    # Донецкая область
    'донецька': (48.0159, 37.8028),
    'донецкая': (48.0159, 37.8028),
    'краматорськ': (48.7389, 37.5843),
    'маріуполь': (47.0971, 37.5497),
    'словянськ': (48.8535, 37.6053),
    
    # Житомирская область
    'житомирська': (50.2547, 28.6587),
    'житомирская': (50.2547, 28.6587),
    'бердичів': (49.8982, 28.6004),
    'коростень': (50.9591, 28.6386),
    'новоград-волинський': (50.5943, 27.6211),
    
    # Закарпатская область
    'закарпатська': (48.6208, 22.2879),
    'закарпатская': (48.6208, 22.2879),
    'мукачево': (48.4392, 22.7177),
    'ужгород': (48.6208, 22.2879),
    'хуст': (48.1762, 23.2977),
    
    # Запорожская область
    'запорізька': (47.8388, 35.1396),
    'запорожская': (47.8388, 35.1396),
    'бердянськ': (46.7738, 36.8037),
    'мелітополь': (46.8550, 35.3587),
    'енергодар': (47.4939, 34.6574),
    
    # Ивано-Франковская область
    'івано-франківська': (48.9226, 24.7111),
    'ивано-франковская': (48.9226, 24.7111),
    'калуш': (49.0414, 24.3552),
    'коломия': (48.5307, 25.0369),
    
    # Киевская область
    'київська': (50.4501, 30.5234),
    'киевская': (50.4501, 30.5234),
    'біла церква': (49.7985, 30.1277),
    'бровари': (50.5110, 30.7909),
    'ірпінь': (50.5196, 30.2505),
    'бориспіль': (50.3482, 30.9560),
    
    # Кировоградская область
    'кіровоградська': (48.5079, 32.2623),
    'кировоградская': (48.5079, 32.2623),
    'олександрія': (48.6693, 33.1161),
    'світловодськ': (49.0465, 33.2416),
    
    # Луганская область
    'луганська': (48.5740, 39.3078),
    'луганская': (48.5740, 39.3078),
    'сєвєродонецьк': (48.9485, 38.4903),
    'лисичанськ': (48.9132, 38.4470),
    
    # Львовская область
    'львівська': (49.8397, 24.0297),
    'львовская': (49.8397, 24.0297),
    'дрогобич': (49.3560, 23.5000),
    'червоноград': (50.3892, 24.2369),
    'стрий': (49.2566, 23.8503),
    
    # Николаевская область
    'миколаївська': (46.9750, 31.9946),
    'николаевская': (46.9750, 31.9946),
    'вознесенськ': (47.5666, 31.3325),
    'первомайськ': (48.0441, 30.8509),
    'южноукраїнськ': (47.8183, 31.1755),
    
    # Одесская область
    'одеська': (46.4825, 30.7233),
    'одесская': (46.4825, 30.7233),
    'ізмаїл': (45.3502, 28.8370),
    'чорноморськ': (46.2984, 30.6557),
    'білгород-дністровський': (46.1962, 30.3507),
    
    # Полтавская область
    'полтавська': (49.5883, 34.5514),
    'полтавская': (49.5883, 34.5514),
    'кременчук': (49.0657, 33.4087),
    'лубни': (50.0183, 32.9977),
    'миргород': (49.9692, 33.6089),
    
    # Ровенская область
    'рівненська': (50.6199, 26.2516),
    'ровенская': (50.6199, 26.2516),
    'дубно': (50.4177, 25.7382),
    'вараш': (51.3514, 25.8553),
    
    # Сумская область
    'сумська': (50.9077, 34.7981),
    'сумская': (50.9077, 34.7981),
    'конотоп': (51.2420, 33.2027),
    'охтирка': (50.3074, 34.8969),
    'шостка': (51.8635, 33.4762),
    
    # Тернопольская область
    'тернопільська': (49.5535, 25.5948),
    'тернопольская': (49.5535, 25.5948),
    'чортків': (49.0170, 25.7985),
    
    # Харьковская область
    'харківська': (49.9935, 36.2304),
    'харьковская': (49.9935, 36.2304),
    'ізюм': (49.1835, 37.2854),
    'лозова': (48.8892, 36.3161),
    'купянськ': (49.7058, 37.6146),
    
    # Херсонская область
    'херсонська': (46.6354, 32.6169),
    'херсонская': (46.6354, 32.6169),
    'нова каховка': (46.7515, 33.3684),
    'каховка': (46.8152, 33.4878),
    
    # Хмельницкая область
    'хмельницька': (49.4229, 26.9873),
    'хмельницкая': (49.4229, 26.9873),
    "камянець-подільський": (48.6843, 26.5853),
    'шепетівка': (50.1851, 27.0635),
    
    # Черкасская область
    'черкаська': (49.4444, 32.0598),
    'черкасская': (49.4444, 32.0598),
    'умань': (48.7489, 30.2218),
    'сміла': (49.2224, 31.8869),
    
    # Черновицкая область
    'чернівецька': (48.2915, 25.9335),
    'черновицкая': (48.2915, 25.9335),
    
    # Черниговская область
    'чернігівська': (51.4982, 31.2893),
    'черниговская': (51.4982, 31.2893),
    'ніжин': (51.0474, 31.8869),
    'прилуки': (50.5934, 32.3877),
    # ... остальные области ...
}
import langdetect
try:
...
if not OPENCAGE_API_KEY:
    raise ValueError("OPENCAGE_API_KEY environment variable is not set")
...
# Кэш для хранения последних известных координат объектов
last_known_positions = {}

# Система предсказания траекторий
def predict_trajectory(threat_id, current_pos, previous_positions):
    ...
    next_pos = (last_pos[0] + dx, last_pos[1] + dy)
    return next_pos

# Функция расчета расстояния между координатами
def calculate_location_distance(coord1, coord2):
...
def calculate_threat_confidence(message, source, history):
    confidence = 0.5  # Базовая достоверность
    
    # Увеличиваем достоверность если:
    if source in ['UkraineAlarmSignal', 'war_monitor']:  # Надежные источники
        confidence += 0.2
    
    # Проверяем подтверждение из нескольких источников
    similar_reports = [m for m in history if 
                      abs(m['timestamp'] - message['timestamp']) < 300 and  # 5 минут
                      calculate_location_distance(m['coordinates'], message['coordinates']) < 10]  # 10 км
    
    if len(similar_reports) >= 2:
        confidence += 0.15 * len(similar_reports)
...
# Инициализация фоновой задачи и приложения
def create_app():
